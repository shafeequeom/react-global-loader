...
const parsePath$2 = memoize(1000)(path => {
  const result = {
    viewMode: undefined,
    storyId: undefined,
    refId: undefined
...
const queryFromString = memoize(1000)(s => qs.parse(s, {
...
const getMatch = memoize(1000)((current, target, startsWith = true) => {
...
const Match = ({
  ...
  path: targetPath,
  startsWith = false
}) => React.createElement(Location, null, _a => {
  var {
    path: urlPath
  } = _a,
      rest = __rest(_a, ["path"]);
